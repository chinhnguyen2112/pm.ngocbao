        ...
        <div class="body_add_project">
            <form id="form_add">
                <div class="main_add_project">
                    ...
                    <div class="this_add_project w_50">
                        <p class="title_input">Chi phi Công việc <span>*</span></p>
                        <input type="number" placeholder="Nhập chi phí" name="price" id="price">
                    </div>
                    <div class="this_add_project w_50">
                    ...
                    <div class="this_add_project w_50">
                        ...
                        <select name="ctv" id="ctv">
                            <option value="0">Chọn ctv thực hiện</option>
                    ...
                    <div class="this_add_project w_50">
                        ...
                        <select name="job_type" id="job_type">
                            ...
                            <?php foreach ($job_type as $val) { ?>
                                <option value="<?= $val['id'] ?>" data-index="<?= $val['status_index'] ?>" data-price="<?= $val['price'] ?>"><?= $val['name'] ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="this_add_project w_50">
                    ...
                    <div class="this_add_project w_50">
                        <p class="title_input">Ghi chú cho QA</p>
                        <textarea style="height: 120px;" name="note_qa"></textarea>
                    </div>
                    <div class="this_add_project w_50">
                    ...
                    <div class="this_add_project w_50">
                        ...
                        <textarea style="height: 120px;" name="info" id="info"></textarea>
                    </div>
                    <div class="this_add_project  w_50">
