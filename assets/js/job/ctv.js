...
var id_filter = 0, job_type = 0,num_job_type = 0, created_at_start = 0, created_at_end = 0, web = 0, sctv = 0, sqa = 0, tss = 0, tse = 0, tes = 0, tee = 0, tcs = 0, tce = 0, dls = 0, dle = 0, cr = 0;
...
function filter() {
    var get_type = '', get_type_num = '', get_created = '', get_created_end = '', get_web = '', get_sctv = '', get_sqa = '', get_tss = '', get_tse = '', get_tes = '', get_tee = '', get_tcs = '', get_tce = '', get_dls = '', get_dle = '', get_cr = '';
    if (web != 0) {
        get_web = '&web=' + web;
    } if (job_type > 0) {
    ...
    var url_filter = "/cong-viec-cong-tac-vien/?id=" + id_filter + get_created + get_created_end + get_dls + get_dle + get_type+get_type_num + get_web + get_sctv + get_sqa + get_tss + get_tse + get_tes + get_tee + get_tcs + get_tce + get_cr;
